...
if Devky:get(DevKyle.."ky:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
Devky:sadd(DevKyle.."ky:Mute:Names"..msg.chat_id_, MuteName)
end
...
Devky:srem(DevKyle.."ky:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
Devky:del(DevKyle.."ky:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = Devky:smembers(DevKyle.."ky:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and Devky:get(DevKyle.."ky:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DevKyleName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DevKyleName then 
DevKyleNames = Devky:smembers(DevKyle.."ky:Mute:Names"..msg.chat_id_) or ""
if DevKyleNames and DevKyleNames[1] then 
for i=1,#DevKyleNames do 
if DevKyleName:match("(.*)("..DevKyleNames[i]..")(.*)") then 
...
Devky:set(DevKyle.."ky:Lock:MuteNames"..msg.chat_id_,true)
end
...
Devky:del(DevKyle.."ky:Lock:MuteNames"..msg.chat_id_)
end
end
end
