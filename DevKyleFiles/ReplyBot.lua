...
if not Devky:get(DevKyle..'ky:Lock:Reply'..msg.chat_id_) then
...
elseif kyConstructor(msg.sender_user_id_, msg.chat_id_) then
...
Dev_ky(msg.chat_id_, msg.id_, 1,rd, 1, 'html')
end
if text == 'دي' or text == 'ديي' or text == 'دي بابه' then 
DevKyleTEAM =  "آخلُِآقٌڪڪ لُِڪڪ 𖠙 😒🔪"
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM, 1, 'md') 
return false
end
if text == 'السلام عليكم' or text == 'سلام عليكم' then 
DevKyleTEAM =  "ياھَہّلْاا ۅﻋ̝̚لْيڪْم الْﺳ̭͠ لْام 𖠙 🤤♥️"
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM, 1, 'md') 
return false
end
if text == '😭💔' or text == '😭😭' or text == '😭😭😭' or text == '😿💔' or text == '😭😭😭' or text == '😭😭😭😭' then 
DevKyleTEAM =  "مآآعٍآشُ آلُِي يزعٍلُِڪڪ 𖠙 😏♥️"
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM, 1, 'md') 
return false
end
if text == '🌚💔' or text == '💔🌚' or text == '🚶‍♂💔' or text == '💔' or text == '😔💔' or text == '🚶‍♀💔' or text == '😭' then 
DevKyleTEAM =  "شبّيي اﻟ̣̣פﻟ̣̣و 𖠙 😿💔"
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM, 1, 'md') 
return false
end
if text == 'باي' or text == 'بااي' or text == 'اروح' or text == 'اروح احسن' or text == 'اولي احسن' or text == 'راح اروح' or text == 'باي انام' then 
DevKyleTEAM =  "أُرٌجُعُ عٍيدِهآآ مٍوو تنِْسةه 𖠙 🤤♥️"
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM, 1, 'md') 
return false
end
if text == 'هلو' or text == 'هلاو' or text == 'هلا' or text == 'هلاوو' or text == 'هيلاو' or text == 'هيلاوو' or text == 'هلاا' then 
local DevKyleTEAM = {"اࠗط็لق֯ق֯ هٞللاࠗ୨و 𖠙 🤤♥️" ,"هۂَلاا نۨہٰورتت يعمۘري 𖠙 🤤♥️" } 
Devky2 = math.random(#DevKyleTEAM) 
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM[Devky2] , 1, 'md') 
return false
end
...
local DevKyleTEAM = {"ماﺷ͠ يةھَہّ يﻋ̝̚مريي ۅاﻧﺗ̲ت 𖠙 🤤♥️" ,"الحۡمۘدللهۂَ ٰوانۨہتت 𖠙 🤤♥️","تمۘامۘ عمۘري ٰوانۨہتت 𖠙 🤤♥️"} 
Devky2 = math.random(#DevKyleTEAM) 
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM[Devky2] , 1, 'md') 
return false
end
if text == 'وينك' or text == 'وينج' then
DevKyleTEAM =  "مْوٌجہوٌدِ يہمْگُ يحلوُ 𖠙 😉♥️"
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM, 1, 'md') 
return false
end
if text == 'بوت عواي' or text == 'بوت زربه' or text == 'البوت عاوي' or text == 'البوت زربه' then
DevKyleTEAM =  "اطردكك تجرب ؟ ، 😕🔪"
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM, 1, 'md') 
return false
end
if text == 'نايمين' or text == 'ميتين' then
DevKyleTEAM =  "طُآمسين ووعٍيوونڪ 𖠙 😪🖤ۦ"
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM, 1, 'md') 
return false
end
if text == 'هلوباي' or text == 'هلو باي' then  
DevKyleTEAM =  "شحۡسۜيت مۘنۨہ هيجۚ ּكتبت ؟ 🌝♥️"
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM, 1, 'md') 
return false
end
if text == 'اكلك' or text == 'اكلج' or text == 'اكلكم' then 
DevKyleTEAM =  "ڪوولُِ مآڪوولُِ لُِآحٍدِ 𖠙 😉♥️"
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM, 1, 'md')
return false
end
if text == 'فرخ' then
DevKyleTEAM =  "ٰوينۨہهۂَ خۡل احۡصرهۂَ 𖠙 😹♥️" 
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM, 1, 'md') 
return false
end
...
DevKyleTEAM =  "لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪" 
Dev_ky(msg.chat_id_, msg.id_, 1, DevKyleTEAM, 1, 'md')
return false
end
end
...
if not Devky:get(DevKyle..'ky:Lock:Reply'..msg.chat_id_) then
Dev_ky(msg.chat_id_, msg.id_, 1, '⌁︙ردود البوت بالتاكيد مفعله ', 1, 'md')
else
Dev_ky(msg.chat_id_, msg.id_, 1, '⌁︙تم تفعيل ردود البوت', 1, 'md')
Devky:del(DevKyle..'ky:Lock:Reply'..msg.chat_id_)
end end
if text == 'تعطيل ردود البوت' or text == 'تعطيل الردود' then
if Devky:get(DevKyle..'ky:Lock:Reply'..msg.chat_id_) then
Dev_ky(msg.chat_id_, msg.id_, 1, '⌁︙ردود البوت بالتاكيد معطله ', 1, 'md')
else
Devky:set(DevKyle..'ky:Lock:Reply'..msg.chat_id_,true)
Dev_ky(msg.chat_id_, msg.id_, 1, '⌁︙تم تعطيل ردود البوت', 1, 'md')
end end
end
end
