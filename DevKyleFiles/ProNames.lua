...
Devky:set(DevKyle.."ky:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if Devky:get(DevKyle.."ky:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = Devky:get(DevKyle.."ky:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = Devky:get(DevKyle.."ky:ProNames:Num"..msg.chat_id_) or 5
...
if Devky:get(DevKyle.."ky:Lock:ProNames"..msg.chat_id_) and Devky:get(DevKyle.."ky:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..Devky:get(DevKyle.."ky:ProNames:Txt"..msg.chat_id_).."(.*)") then 
Devky:srem(DevKyle..'ky:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = Devky:get(DevKyle.."ky:ProNames:Num"..msg.chat_id_) or 5
local UserNum = Devky:get(DevKyle.."ky:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
...
Devky:del(DevKyle.."ky:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
Devky:set(DevKyle.."ky:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
Devky:del(DevKyle.."ky:Lock:ProNames"..msg.chat_id_)
end
end
